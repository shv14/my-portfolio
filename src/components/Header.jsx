  ...
  return (
    ...
    >
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-2">
        <a
          className="block w-[12rem] xl:mr-8 text-xl uppercase text-n-1 transition-colors hover:text-color-1 font-semibold py-2 pl-10 font-code"
          href="#hero"
        >
          Shivansh
        </a>
        ...
        <Button
          href="https://drive.google.com/file/d/1qRRkRPryNArR5owt5eaParFpQw8TpFqO/view?usp=sharing"
